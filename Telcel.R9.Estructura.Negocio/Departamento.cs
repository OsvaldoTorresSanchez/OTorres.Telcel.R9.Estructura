    ...
    public class Departamento
    {
        ...
        public static Telcel.R9.Estructura.Negocio.Result GetAllEF()
        {
            ...
            try
            {
                ...
                {
                    var resultQuery = context.DepartamentoGetAll().ToList();
                    ...
                    if (resultQuery != null)
                    {
                        ...
                        {
                            Telcel.R9.Estructura.Negocio.Departamento materia = new Telcel.R9.Estructura.Negocio.Departamento();
                            materia.IdDepartamento = obj.IdDEpatarmento;
